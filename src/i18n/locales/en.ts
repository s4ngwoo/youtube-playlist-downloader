...
export const en: MessageCatalog = {
  ...
  "form.concurrencyHint":
    "How many tracks run at once (1–8). Default 3. Shares your link and CPU, so higher values often are not proportionally faster.",
  ...
  "tracks.filterFailed": "Failed ({count})",
  "tracks.emptyFailedFilter": "No failed tracks in this filter.",
  ...
  "history.openFolder": "Folder",
  "history.openFolderTitle": "Open download folder",
  "history.openFolderMissing": "No download folder is stored for this entry.",
  "history.openFolderFailed": "Could not open the folder.",
  ...
  "log.refresh": "Refresh",
  "log.refreshFailed": "Could not refresh logs.",
  "log.openFile": "Reveal log file in file manager",
  "log.openFileMissing": "Log path is unknown yet. Try refresh.",
  "log.openFileFailed": "Could not reveal the log file.",
  "log.clear": "Clear logs",
  "log.clearFailed": "Could not clear logs.",
