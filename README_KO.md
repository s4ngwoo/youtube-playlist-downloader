...
5. [x] 스모크 후속: 비공개/삭제 라벨 · 히스토리 폴더 · 고급 콘솔 · 자막 기본 OFF
6. [x] 비공개/삭제 건너뜀 라벨 정확도 (availability · EN/KO 제목)
7. [x] 히스토리 폴더 열기 (reveal-in-dir)
8. [x] 고급 모드 트랙별 yt-dlp 콘솔
9. [x] 오디오 추출 시 자막 다운로드/임베드 기본 OFF
