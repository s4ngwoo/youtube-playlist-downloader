...
1. **폴더 변경**으로 저장 위치를 지정합니다 (로컬에 기억됩니다).
2. 유튜브 영상 또는 플레이리스트 URL을 붙여넣습니다.
3. 메타데이터를 불러온 뒤 필요하면 트랙을 선택하고 다운로드를 시작합니다.
4. 트랙별 진행 상태를 확인하고, 실패 항목은 재시도할 수 있습니다.
5. 모바일용 ZIP 내보내기나 앱 로그 뷰어를 사용할 수 있습니다.
6. **취소** 시 백그라운드 프로세스까지 정리됩니다.
